...
long WINAPI DioInpByteSR(short Id, short PortNo, unsigned char *Data, unsigned short *Timestanp, BYTE Mode);
long WINAPI DioInpBitSR(short Id, short BitNo, unsigned char *Data, unsigned short *Timestanp, BYTE Mode);
...
long WINAPI DioInpMultiByteSR(short Id, short *PortNo, short PortNum, unsigned char *Data, unsigned short *Timestanp, unsigned char Mode);
long WINAPI DioInpMultiBitSR(short Id, short *BitNo, short BitNum, unsigned char *Data, unsigned short *Timestanp, unsigned char Mode);
...
long WINAPI DioGetMaxCountChannels(short Id, short *ChannelNum);

// Counter function
long WINAPI DioSetCountEdge(short Id, short *ChNo, short ChNum, short *CountEdge);
long WINAPI DioGetCountEdge(short Id, short *ChNo, short ChNum, short *CountEdge);
long WINAPI DioSetCountMatchValue(short Id, short *ChNo, short ChNum, short *CompareRegNo, unsigned long *CompareCount);
long WINAPI DioStartCount(short Id, short *ChNo, short ChNum);
long WINAPI DioStopCount(short Id, short *ChNo, short ChNum);
long WINAPI DioGetCountStatus(short Id, short *ChNo, short ChNum, unsigned long *CountStatus);
long WINAPI DioCountPreset(short Id, short *ChNo, short ChNum, unsigned long *PresetCount);
long WINAPI DioReadCount(short Id, short *ChNo, short ChNum, unsigned long *Count);
long WINAPI DioReadCountSR(short Id, short *ChNo, short ChNum, unsigned long *Count, unsigned short *Timestanp, BYTE Mode);
...
long WINAPI DioResetPatternEvent(short Id, BYTE *Data);
long WINAPI DioGetPatternEventStatus(short Id, short *Status);
...
// NET
//-------------------------------------------------
#define	DIONET_MODE_DIRECT				0
#define	DIONET_MODE_AP					1
//-------------------------------------------------
// Counter
//-------------------------------------------------
#define	DIO_COUNT_EDGE_UP				1
#define	DIO_COUNT_EDGE_DOWN				2
