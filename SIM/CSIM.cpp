...
int CSIM::set_sway_io() {
    ...
    double th_tily = (double)(sim_counter % 1000) * 0.0063;//0.0063 = 2π/1000 10msec scan 10秒周期
    double a_til = 0.001745;//傾斜角振幅 0.1deg　1deg 0.01745rad
    double tilt_y = a_til * sin(th_tily);
    double tilt_dy = a_til * 0.63 * cos(th_tily);//ω＝2π/10=0.63
 
#if 0
   double tilt_x = 0.02;
   double tilt_y = 0.03;
   double tilt_dx = 0.01;
   double tilt_dy = 0.02;//ω＝2π/10=0.63
#endif
