...
int COteIF::init_proc() {
	...
	hWnd_if = open_work_Wnd(hWnd_parent);					//操作端末ウィンドOPEN
	hwnd_subwnd_now = open_connect_Wnd(hWnd_if);			//接続表示子ウィンドウ　
